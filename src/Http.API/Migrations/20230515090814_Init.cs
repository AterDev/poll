        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedTime = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    IssueNo = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    Title = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    Description = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                    PollType = table.Column<int>(type: "integer", nullable: false),
                    EffectiveStartDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    EffectiveEndDate = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
                    CategoryId = table.Column<Guid>(type: "uuid", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PollIssues", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PollIssues_PollCategories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PollOptions_PollIssues_IssueId",
                        column: x => x.IssueId,
                        principalTable: "PollIssues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    Name = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    PollIssueId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PollTags", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PollTags_PollIssues_PollIssueId",
                        column: x => x.PollIssueId,
                        principalTable: "PollIssues",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PollIssues_CategoryId",
                table: "PollIssues",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PollOptions_IssueId",
                table: "PollOptions",
                column: "IssueId");

            migrationBuilder.CreateIndex(
                name: "IX_PollTags_PollIssueId",
                table: "PollTags",
                column: "PollIssueId");
